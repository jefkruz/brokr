            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="{{route('profile')}}" role="button" data-bs-toggle="dropdown">
                            <div class="header-info">
                                <span class="text-black">{{ucwords(Auth::user()->name)}}</span>
                                <p class="fs-12 mb-0">Realtor</p>
                            </div>
                            <img src="{{asset( 'storage/users/'.Auth::user()->avatar)??'storage/users/default.png'}}" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="{{route('admin')}}" class="dropdown-item ai-icon">
