        ...
        <div class="card overflow-hidden">
            <div class="text-center p-3 overlay-box " style="background-image: url(storage/img1.jpg);">
                <div class="profile-photo">
                    <img src="{{asset( 'storage/users/'.$referral->avatar)??'storage/users/default.png'}}" width="100" class="img-fluid rounded-circle" alt="">
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="example3" class="display min-w850">
                            ...
                            @foreach($downlines as $referral)
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td><img class="rounded-circle" width="35" src="{{asset( 'storage/users/'.$referral->avatar)??'storage/users/default.png'}}" alt=""></td>
